                                ...
                                <BCol md="12" lg="12" xl="12">
                                    <BCard no-body class="overflow-hidden shadow-sm">
                                        <div class="pt-4 px-4">
                                            ...
                                            <p>Pastikan akaun anda selamat dengan kata laluan yang kukuh.</p>
                                        </div>
                                        ...
                                        <BCardBody class="pt-0">
                                            ...
                                            <BForm class="p-2" @submit.prevent="submit">
                                                <!-- Current Password -->
                                                <BFormGroup class="mb-3" label="Kata Laluan Lama"
                                                    label-for="currentPassword"
                                                    v-if="currentUser?.peranan === 'pengguna'">
                                                    <BInputGroup>
                                                        <BFormInput :type="show.current ? 'text' : 'password'"
                                                            id="currentPassword" v-model="form.currentPassword"
                                                            placeholder="Masukkan kata laluan lama"
                                                            :class="{ 'is-invalid': submitted && v$.form.currentPassword.$error }" />
                                                        <BButton variant="light" @click="show.current = !show.current">
                                                            <i
                                                                :class="show.current ? 'fas fa-eye-slash' : 'fas fa-eye'"></i>
                                                        </BButton>
                                                    </BInputGroup>
                                                    <div v-if="submitted && v$?.form?.currentPassword?.$error"
                                                        class="invalid-feedback d-block">
                                                        <span v-if="v$.form.currentPassword.required.$invalid">Kata
                                                            laluan
                                                            terkini
                                                            diperlukan</span>
                                                    </div>
                                                ...
                                                <!-- New Password -->
                                                <BFormGroup class="mb-3" label="Kata Laluan Baharu"
                                                    label-for="newPassword">
                                                    <BInputGroup>
                                                        <BFormInput :type="show.newPass ? 'text' : 'password'"
                                                            id="newPassword" v-model="form.newPassword"
                                                        ...
                                                        <BButton variant="light" @click="show.newPass = !show.newPass">
                                                            <i
                                                                :class="show.newPass ? 'fas fa-eye-slash' : 'fas fa-eye'"></i>
                                                        </BButton>
                                                    </BInputGroup>
                                                    ...
                                                    <div class="mt-2">
                                                        <div class="d-flex justify-content-between align-items-center">
                                                            ...
                                                            <small
                                                                v-if="form.newPassword && form.newPassword.length < 12">(gunakan
                                                                12+
                                                        ...
                                                        <div class="progress" style="height: 6px;">
                                                            <div class="progress-bar" role="progressbar"
                                                                ...
                                                                :class="strength.barClass" aria-valuemin="0"
                                                                aria-valuemax="100">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <ul class="mt-2 mb-0 small text-muted">
                                                        ...
                                                        <li>Mesti ada simbol khas seperti<span
                                                                class="text-muted fst-italic bg-light"> @, #, $, %
                                                ...
                                                <!-- Confirm Password -->
                                                <BFormGroup class="mb-3" label="Sahkan Kata Laluan Baharu"
                                                    label-for="confirmPassword">
                                                    <BInputGroup>
                                                        <BFormInput :type="show.confirm ? 'text' : 'password'"
                                                        ...
                                                        <BButton variant="light" @click="show.confirm = !show.confirm">
                                                            <i
                                                                :class="show.confirm ? 'fas fa-eye-slash' : 'fas fa-eye'"></i>
                                                        </BButton>
                                                    </BInputGroup>
...
export default {
    components: { Layout, PageHeader, Loader, ProfileCard, SweetAlert },
    computed: {
        currentUser() {
