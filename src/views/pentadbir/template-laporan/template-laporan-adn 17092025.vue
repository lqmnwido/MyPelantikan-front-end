...
export default {
    ...
    data() {
        return {
            ...
            editorInstance: null,
            DUN: [
                { nama: 'YB Senator Dato’ Ahmad bin Dato’ Sri Hj Ibrahim', tarikhLantik: '22.07.2022', tarikhTamat: '21.07.2025', penggal: 'Pertama', parti: 'PBB', wakil: 'Kedah' },
                { nama: 'YB Senator Datuk Lim Pay Hen', tarikhLantik: ['04.12.2017', '26.06.2022'], tarikhTamat: ['03.12.2020', '25.06.2025'], penggal: ['Pertama', 'Kedua'], parti: 'MCA', wakil: 'Melaka' },
                { nama: 'YB Senator Dato’ Dr. Ahmad Azam bin Hamzah', tarikhLantik: ['09.05.2019', '15.08.2022'], tarikhTamat: ['08.05.2022', '14.08.2025'], penggal: ['Pertama', 'Kedua'], parti: 'PKR', wakil: 'Perlis' },
                { nama: 'YB Senator Tuan Amir bin Ghazali', tarikhLantik: ['07.03.2023'], tarikhTamat: ['06.03.2026'], penggal: ['Pertama'], parti: 'PKR', wakil: 'Perlis' },
                { nama: 'YB Senator Dr. Lingeshwaran a/l Dato’ Seri R. Arunasalam', tarikhLantik: ['07.03.2023'], tarikhTamat: ['06.03.2026'], penggal: ['Pertama'], parti: 'DAP', wakil: 'Sabah' },
                { nama: 'YB Senator Tuan Haji Hussin bin Ismail', tarikhLantik: ['15.03.2023'], tarikhTamat: ['14.03.2026'], penggal: ['Pertama'], parti: 'PAS', wakil: 'P.Pinang' },
                { nama: 'YB Senator Tuan Haji Abdul Nasir bin Haji Idris', tarikhLantik: ['20.03.2023'], tarikhTamat: ['19.03.2026'], penggal: ['Pertama'], parti: 'PAS', wakil: 'P.Pinang' },
            ...
            wakil: ['Sarawak', 'Johor', 'P.Pinang', 'Terengganu', 'Kedah', 'Perak', 'Kelantan', 'Melaka', 'Sabah', 'Perlis', 'Selangor', 'Pahang', 'N.Sembilan'],
            totalRowsDUN: 26,
            kategoriDUN: 'DUN',
            notaContent: '',
    ...
    // Step 3: Build rows based on wakil list (allow duplication)
    this.wakil.forEach(w => {
        const members = groupedByWakil[w] || [];

        // push up to 2 members for each wakil slot
        for (let i = 0; i < 2; i++) {
            if (members[i]) {
                rows.push({
                    ...members[i],
    ...
    // Step 4: Final sort across all rows by tarikhTamat
    rows.sort((a, b) => parseDate(b.latestTamat) - parseDate(a.latestTamat));
